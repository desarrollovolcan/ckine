    ...
    <div class="scrollbar" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/agenda'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/pacientes'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/profesionales'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/box'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/servicios'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/fichas'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/reportes'); ?>" class="side-nav-link">
            ...
            <?php if ($isAdmin): ?>
                ...
                <li class="side-nav-item">
                    <a href="<?php echo app_path('/usuarios'); ?>" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    <a href="<?php echo app_path('/roles'); ?>" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    <a href="<?php echo app_path('/auditoria'); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo app_path('/portal'); ?>" class="side-nav-link">
