                    ...
                    <ul class="list-group">
                        <?php foreach ($attachments as $attachment): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <a href="<?php echo app_path('/' . ltrim($attachment['file_path'], '/')); ?>" target="_blank" class="btn btn-sm btn-outline-secondary">Ver</a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
                <form method="post" action="<?php echo app_path('/fichas/adjunto'); ?>" enctype="multipart/form-data" class="mt-3">
    ...
    <div class="col-xl-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <hr>
                <form method="post" action="<?php echo app_path('/fichas/evaluacion'); ?>">
                    <input type="hidden" name="csrf_token" value="<?php echo csrf_token(); ?>">
                    <input type="hidden" name="patient_id" value="<?php echo (int)$patient['id']; ?>">
                    <div class="row g-2">
                        <div class="col-12">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <hr>
                <form method="post" action="<?php echo app_path('/fichas/evolucion'); ?>">
                    <input type="hidden" name="csrf_token" value="<?php echo csrf_token(); ?>">
                    <input type="hidden" name="patient_id" value="<?php echo (int)$patient['id']; ?>">
                    <div class="row g-2">
                        <div class="col-12">
