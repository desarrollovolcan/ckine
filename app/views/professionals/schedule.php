<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo app_path('/profesionales'); ?>" class="btn btn-light btn-sm">Volver</a>
    </div>
    <div class="card-body">
        <form method="post" action="<?php echo app_path('/profesionales/horarios'); ?>" class="row g-2 align-items-end">
