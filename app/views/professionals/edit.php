...
<form method="post" action="<?php echo $baseUrl; ?>professionals/<?php echo $professional['id']; ?>/update">
    <input type="hidden" name="csrf_token" value="<?php echo CSRF::token(); ?>">
    <?php include __DIR__ . '/form.php'; ?>
    <button class="btn btn-primary" type="submit">Actualizar</button>
    <a class="btn btn-light" href="<?php echo $baseUrl; ?>professionals">Cancelar</a>
</form>
<hr>
<h5>Horarios</h5>
<form method="post" action="<?php echo $baseUrl; ?>professionals/<?php echo $professional['id']; ?>/schedules">
    <input type="hidden" name="csrf_token" value="<?php echo CSRF::token(); ?>">
    <div class="row">
    ...
    <tbody>
        <?php foreach ($schedules as $schedule): ?>
            <tr>
                ...
                <td>
                    <form method="post" action="<?php echo $baseUrl; ?>professionals/<?php echo $professional['id']; ?>/schedules/<?php echo $schedule['id']; ?>/delete" onsubmit="return confirm('¿Eliminar horario?')">
                        <input type="hidden" name="csrf_token" value="<?php echo CSRF::token(); ?>">
