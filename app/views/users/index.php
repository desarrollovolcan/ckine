        ...
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td class="d-flex gap-2">
                    <a class="btn btn-sm btn-info" href="/users/<?php echo $user['id']; ?>/edit">Editar</a>
                    <form method="post" action="/users/<?php echo $user['id']; ?>/delete" onsubmit="return confirm('¿Eliminar usuario?')">
