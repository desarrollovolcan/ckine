...
<div class="d-flex justify-content-between mb-3">
    <h4>Agenda</h4>
    <a class="btn btn-primary" href="<?php echo $baseUrl; ?>appointments/create">Nueva cita</a>
</div>
<form class="row g-2 mb-3" method="get" action="<?php echo $baseUrl; ?>appointments">
    <div class="col-md-3">
        ...
        <?php foreach ($appointments as $appointment): ?>
            <tr>
                ...
                <td class="d-flex gap-2">
                    <a class="btn btn-sm btn-info" href="<?php echo $baseUrl; ?>appointments/<?php echo $appointment['id']; ?>/edit">Editar</a>
                    <form method="post" action="<?php echo $baseUrl; ?>appointments/<?php echo $appointment['id']; ?>/status">
                    ...
                    <form method="post" action="<?php echo $baseUrl; ?>appointments/<?php echo $appointment['id']; ?>/delete" onsubmit="return confirm('¿Eliminar cita?')">
                        <input type="hidden" name="csrf_token" value="<?php echo CSRF::token(); ?>">
