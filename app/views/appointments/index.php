<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo app_path('/agenda/nueva'); ?>" class="btn btn-primary btn-sm">Nueva cita</a>
    </div>
    <div class="card-body">
        <form method="get" class="row g-2 mb-3">
            ...
            <div class="col-12">
                ...
                <a href="<?php echo app_path('/agenda'); ?>" class="btn btn-light">Limpiar</a>
            </div>
        </form>
                ...
                <tbody>
                    <?php foreach ($appointments as $appointment): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="<?php echo app_path('/agenda/editar'); ?>?id=<?php echo (int)$appointment['id']; ?>" class="btn btn-sm btn-outline-primary">Editar</a>
                                <form method="post" action="<?php echo app_path('/agenda/estado'); ?>" class="d-inline">
                                ...
                                <form method="post" action="<?php echo app_path('/agenda/eliminar'); ?>" class="d-inline" onsubmit="return confirm('¿Eliminar cita?');">
                                    <input type="hidden" name="csrf_token" value="<?php echo csrf_token(); ?>">
                                    <input type="hidden" name="id" value="<?php echo (int)$appointment['id']; ?>">
