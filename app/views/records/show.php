...
<div class="row">
    <div class="col-md-6">
        ...
        <?php else: ?>
            <form method="post" action="/records/<?php echo $patient['id']; ?>/evaluation">
    ...
    <div class="col-md-6">
        <h5>Evoluciones</h5>
        <form method="post" action="/records/<?php echo $patient['id']; ?>/evolutions">
            <input type="hidden" name="csrf_token" value="<?php echo CSRF::token(); ?>">
            <div class="mb-2">
...
<hr>
<h5>Adjuntos</h5>
<form method="post" action="/records/<?php echo $patient['id']; ?>/attachments" enctype="multipart/form-data">
    <input type="hidden" name="csrf_token" value="<?php echo CSRF::token(); ?>">
