        ...
        <?php foreach ($roles as $role): ?>
            <tr>
                ...
                <td class="d-flex gap-2">
                    <a class="btn btn-sm btn-info" href="/roles/<?php echo $role['id']; ?>/edit">Editar</a>
                    <form method="post" action="/roles/<?php echo $role['id']; ?>/delete" onsubmit="return confirm('¿Eliminar rol?')">
