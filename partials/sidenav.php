...
<div class="sidenav-menu">
    ...
    <div data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="/audit" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="/portal" class="side-nav-link" target="_blank">
            ...
            <li class="side-nav-item">
                <a href="/auth/logout" class="side-nav-link">
